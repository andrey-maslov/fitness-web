...
export const mockTrainingCycles = [
  {
    ...
    comment: "Цикл, направленный на увеличение мышечной массы с постепенным ростом веса.",
...
export const mockWorkouts = [
  ...
  },
  {
    ...
    comment: "Тренировка для улучшения выносливости, с упором на кардионагрузку.",
    exercises: [
      {
        name: "Бег на дорожке",
